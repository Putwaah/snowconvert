...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Account_Details_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Account_Details_Proc';
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ;  
        ...
        FROM (select 
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv1 
                         ON gcck.SEGMENT1 = ffv1.flex_value             and ffv1.flex_value_set_id = 1014124  
            LEFT OUTER JOIN  steph_apps_FND_FLEX_VALUES_tl_bz   ffvt1
                         ON ffv1.flex_value_id = ffvt1.flex_value_id    and ffvt1.language = 'US'
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv2 
                         ON gcck.SEGMENT2 = ffv2.flex_value             and ffv2.flex_value_set_id = 1014125  
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES_tl_bz    ffvt2 
                         ON ffv2.flex_value_id = ffvt2.flex_value_id    and ffvt2.language = 'US'
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv3
                         ON gcck.SEGMENT3 = ffv3.flex_value             and ffv3.flex_value_set_id = 1014126  
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES_tl_bz    ffvt3
                         ON ffv3.flex_value_id = ffvt3.flex_value_id    and ffvt3.language = 'US'
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv4
                         ON gcck.SEGMENT4 = ffv4.flex_value             and ffv4.flex_value_set_id = 1014127 
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES_tl_bz    ffvt4
                         ON ffv4.flex_value_id = ffvt4.flex_value_id    and ffvt4.language = 'US'
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv5
                         ON gcck.SEGMENT5 = ffv5.flex_value             and ffv5.flex_value_set_id = 1014129 
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES_tl_bz    ffvt5 
                         ON ffv5.flex_value_id = ffvt5.flex_value_id    and ffvt5.language = 'US'
            ...
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES#_bz      ffv6
                         ON gcck.SEGMENT6 = ffv6.flex_value             and ffv6.flex_value_set_id = 1014128  
            LEFT OUTER JOIN steph_apps_FND_FLEX_VALUES_tl_bz    ffvt6
                         ON ffv6.flex_value_id = ffvt6.flex_value_id    and ffvt6.language = 'US'  
           ); 
     g_status   := 'COMPLETED';
    ...
    ****************************************************************************************/
    PROCEDURE Recreate_IO_Details_Proc
   IS  v_procedure varchar2(100) := 'Recreate_IO_Details_Proc';
       v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ; 
        ...
        IO_DETAILS_TEMP ( SELECT 
                                            ...
                                            left outer join steph_apps_FND_LOOKUP_VALUES_bz     flv
                                              on flv.lookup_type = 'EMR ORIGINATOR WH LS I3100' and flv.language='US'
    ...
    ****************************************************************************************/
   PROCEDURE Recreate_OU_Details_Proc
   IS  v_procedure varchar2(100) := 'Recreate_OU_Details_Proc';
       v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ; 
        ...
        OU_DETAILS_TEMP  ( SELECT 
                                        ...
                                        from steph_apps_hr_operating_units_bz hou , 
                                             steph_apps_HR_ALL_ORGANIZATION_UNITS_bz haou , 
                                             steph_apps_hr_locations_all_bz hla , 
                                             steph_apps_gl_sets_of_books_bz gsob   
                                        where hou.organization_id = haou.organization_id(+) 
...
****************************************************************************************/
   ...
   IS v_procedure varchar2(100) := 'Recreate_Structure_Reseau_Proc';
      v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ; 
        ...
        FROM (select distinct
                ...
                left outer join steph_apps_FND_LOOKUP_VALUES_bz flv
                    ...
                    and flv.LANGUAGE = 'US' AND flv.LOOKUP_TYPE = 'EMR BRANCH AREA MAPPING MLS'
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Intercompany_Parameters_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Intercompany_Parameters_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment1_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment1_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment2_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment2_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ;  
        ...
        SELECT *
        FROM (select  ffv.flex_value                                        LOCATION_GL_SEGMENT2,
                    fifs.id_flex_num                                        CHART_OF_ACCOUNTS_ID,
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment3_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment3_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ;  
        ...
        SELECT *
        FROM (select  ffv.flex_value                                        DEPARTMENT_GL_SEGMENT3,
                    fifs.id_flex_num                                        CHART_OF_ACCOUNTS_ID,
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment4_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment4_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
...
*/
      INSERT INTO GL_SEGMENT4_NATURAL_ACCOUNT_TEMP
        SELECT *
        FROM ( with creation_group_temp as(
            SELECT 
                ...
                (
                    ...
                    WHERE ffvt1.flex_value_id = 
                        (
                            SELECT ffv2.flex_value_id 
                            FROM steph_apps_FND_FLEX_VALUES#_bz ffv2
                            WHERE ffv2.flex_value_set_id = ffv.flex_value_set_id
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment5_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment5_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ;  
        ...
        SELECT *
        FROM (select  ffv.flex_value                                            PRODUCT_GROUP_GL_SEGMENT5,
                    fifs.id_flex_num                                            CHART_OF_ACCOUNTS_ID,
...
****************************************************************************************/
    ...
    PROCEDURE Recreate_Gl_Segment6_Proc
   IS   v_procedure varchar2(100) := 'Recreate_Gl_Segment6_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
   BEGIN
     ...
     g_etape     := $$plsql_line + 1  || ' - num error line'  ;  
        ...
        SELECT *
        FROM (select  ffv.flex_value                                        INTERCOMPANY_GL_SEGMENT6,
                    fifs.id_flex_num                                        CHART_OF_ACCOUNTS_ID,
...
****************************************************************************************/
    ...
    PROCEDURE DAILY_CONVERSION_RATES_PROC
    IS  v_procedure varchar2(100) := 'DAILY_CONVERSION_RATES_PROC';
        v_date_deb_proc  TIMESTAMP := sysdate;
    BEGIN
...
****************************************************************************************/    
    ...
    PROCEDURE FIXED_RATE_PROC
    IS v_procedure varchar2(100) := 'Fixed_rate_Proc';
        v_date_deb_proc  TIMESTAMP := sysdate;
    BEGIN
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE Recreate_Customer_Segement_Proc IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE COMMANDE_HORS_BACKLOG_PROC IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE ORDER_CHARGES_PROC IS
...
BEGIN
    g_programme := $$plsql_unit || '.' || v_procedure ;      
     ...
     INSERT INTO ORDER_CHARGES
        ...
        WHERE (ARITHMETIC_OPERATOR = 'LUMPSUM' OR ARITHMETIC_OPERATOR = '%') 
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE UOM_CONVERSION_RATE_PROC IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE DOCUMENT_EIA_LINE_TEXT_TEMP_PROC IS
...
BEGIN
    g_programme := $$plsql_unit || '.' || v_procedure ;      
     ...
     INSERT INTO DOCUMENT_EIA_LINE_TEXT_TEMP
        ...
        FROM 
            steph_apps_fnd_attached_documents_bz fndd2
        INNER JOIN 
            steph_apps_fnd_documents_bz fnd2 ON fnd2.document_id = fndd2.document_id
        INNER JOIN 
            steph_apps_fnd_documents_short_text_bz fns2 ON fnd2.media_id = fns2.media_id
        INNER JOIN 
            (SELECT category_id FROM steph_apps_fnd_document_categories_tl_bz WHERE user_name = 'EIA Line Text' AND language = 'US') fdct ON fndd2.category_id = fdct.category_id
        GROUP BY 
            fndd2.pk1_value
        ORDER BY 
            fndd2.pk1_value;
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE MANUAL_ADJUSTMENTS_TEMP_PROC IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE FILE_VAR_BUSINESS_SEGMENT_NEW_PROC IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE FILE_VAR_BUSINESS_SEGMENT_OLD_PROC IS
...
/****************************************************************************************
    ...
    * <parameter>      <TYPE>      <Desc>
    ****************************************************************************************/    
PROCEDURE steph_apps_fnd_flex_value_tl_PROC IS
...
BEGIN
    ...
    ****************************************************************************************/ 
    ...
    PROCEDURE Fnd_flex_values_us_proc IS
...
BEGIN
    g_programme := $$plsql_unit || '.' || v_procedure ;      
     ...
     select 
        ...
        ffv.BZ_BIS_CREATED_BY                  BZ_BIS_CREATED_BY_ffv_values ,             
        ffv.BZ_BIS_CREATION_DATE               BZ_BIS_CREATION_DATE_ffv_values , 
        ffv.BZ_BIS_UPTATED_BY                  BZ_BIS_UPTATED_BY_ffv_values ,              
        ffv.BZ_BIS_UPDATED_DATE                BZ_BIS_UPDATED_DATE_ffv_values , 
        ffv.FETCH_YEAR                         FETCH_YEAR_ffv_values ,              
        ffv.FETCH_MONTH                        FETCH_MONTH_ffv_values ,              
        ffv.FETCH_DAY                          FETCH_DAY_ffv_values ,              
        ffv.FLEX_VALUE_SET_ID                  FLEX_VALUE_SET_ID_ffv_values ,               
        ffv.FLEX_VALUE_ID                     FLEX_VALUE_ID_ffv_values ,               
        ffv.FLEX_VALUE                        FLEX_VALUE_ffv_values ,             
        ffv.LAST_UPDATE_DATE                  LAST_UPDATE_DATE_ffv_values ,               
        ffv.LAST_UPDATED_BY                    LAST_UPDATED_BY_ffv_values ,               
        ffv.CREATION_DATE                    CREATION_DATE_ffv_values ,               
        ffv.CREATED_BY                         CREATED_BY_ffv_values ,               
        ffv.LAST_UPDATE_LOGIN                  LAST_UPDATE_LOGIN_ffv_values ,               
        ffv.ENABLED_FLAG                      ENABLED_FLAG_ffv_values ,             
        ffv.SUMMARY_FLAG                      SUMMARY_FLAG_ffv_values ,             
        ffv.START_DATE_ACTIVE                START_DATE_ACTIVE_ffv_values ,               
        ffv.END_DATE_ACTIVE                  END_DATE_ACTIVE_ffv_values ,               
        PARENT_FLEX_VALUE_LOW            PARENT_FLEX_VALUE_LOW_ffv_values ,             
        ffv.PARENT_FLEX_VALUE_HIGH            PARENT_FLEX_VALUE_HIGH_ffv_values ,             
        ffv.STRUCTURED_HIERARCHY_LEVEL         STRUCTURED_HIERARCHY_LEVEL_ffv_values ,               
        ffv.HIERARCHY_LEVEL                   HIERARCHY_LEVEL_ffv_values ,             
        ffv.COMPILED_VALUE_ATTRIBUTES         COMPILED_VALUE_ATTRIBUTES_ffv_values ,             
        ffv.VALUE_CATEGORY                    VALUE_CATEGORY_ffv_values ,             
        ffv.ATTRIBUTE1                        ATTRIBUTE1_ffv_values ,             
        ffv.ATTRIBUTE2                        ATTRIBUTE2_ffv_values ,             
        ffv.ATTRIBUTE3                       ATTRIBUTE3_ffv_values ,             
        ffv.ATTRIBUTE4                        ATTRIBUTE4_ffv_values ,             
        ffv.ATTRIBUTE5                       ATTRIBUTE5_ffv_values ,             
        ffv.ATTRIBUTE6                        ATTRIBUTE6_ffv_values ,             
        ffv.ATTRIBUTE7                        ATTRIBUTE7_ffv_values ,             
        ffv.ATTRIBUTE8                        ATTRIBUTE8_ffv_values ,             
        ffv.ATTRIBUTE9                        ATTRIBUTE9_ffv_values ,             
        ffv.ATTRIBUTE10                       ATTRIBUTE10_ffv_values ,             
        ffv.ATTRIBUTE11                       ATTRIBUTE11_ffv_values ,             
        ffv.ATTRIBUTE12                       ATTRIBUTE12_ffv_values ,             
        ffv.ATTRIBUTE13                       ATTRIBUTE13_ffv_values ,             
        ffv.ATTRIBUTE14                       ATTRIBUTE14_ffv_values ,             
        ffv.ATTRIBUTE15                       ATTRIBUTE15_ffv_values ,             
        ffv.ATTRIBUTE16                       ATTRIBUTE16_ffv_values ,             
        ffv.ATTRIBUTE17                       ATTRIBUTE17_ffv_values ,             
        ffv.ATTRIBUTE18                       ATTRIBUTE18_ffv_values ,             
        ffv.ATTRIBUTE19                      ATTRIBUTE19_ffv_values ,             
        ffv.ATTRIBUTE20                       ATTRIBUTE20_ffv_values ,             
        ffv.ATTRIBUTE21                       ATTRIBUTE21_ffv_values ,             
        ffv.ATTRIBUTE22                       ATTRIBUTE22_ffv_values ,             
        ffv.ATTRIBUTE23                       ATTRIBUTE23_ffv_values ,             
        ffv.ATTRIBUTE24                       ATTRIBUTE24_ffv_values ,             
        ffv.ATTRIBUTE25                       ATTRIBUTE25_ffv_values ,             
        ffv.ATTRIBUTE26                       ATTRIBUTE26_ffv_values ,             
        ffv.ATTRIBUTE27                       ATTRIBUTE27_ffv_values ,             
        ffv.ATTRIBUTE28                       ATTRIBUTE28_ffv_values ,             
        ffv.ATTRIBUTE29                       ATTRIBUTE29_ffv_values ,             
        ffv.ATTRIBUTE30                       ATTRIBUTE30_ffv_values ,             
        ffv.ATTRIBUTE31                       ATTRIBUTE31_ffv_values ,             
        ffv.ATTRIBUTE32                       ATTRIBUTE32_ffv_values ,             
        ffv.ATTRIBUTE33                       ATTRIBUTE33_ffv_values ,             
        ffv.ATTRIBUTE34                       ATTRIBUTE34_ffv_values ,             
        ffv.ATTRIBUTE35                       ATTRIBUTE35_ffv_values ,             
        ffv.ATTRIBUTE36                       ATTRIBUTE36_ffv_values ,             
        ffv.ATTRIBUTE37                       ATTRIBUTE37_ffv_values ,             
        ffv.ATTRIBUTE38                       ATTRIBUTE38_ffv_values ,             
        ffv.ATTRIBUTE39                       ATTRIBUTE39_ffv_values ,             
        ffv.ATTRIBUTE40                       ATTRIBUTE40_ffv_values ,             
        ffv.ATTRIBUTE41                       ATTRIBUTE41_ffv_values ,             
        ffv.ATTRIBUTE42                       ATTRIBUTE42_ffv_values ,             
        ffv.ATTRIBUTE43                       ATTRIBUTE43_ffv_values ,             
        ffv.ATTRIBUTE44                       ATTRIBUTE44_ffv_values ,             
        ffv.ATTRIBUTE45                       ATTRIBUTE45_ffv_values ,             
        ffv.ATTRIBUTE46                       ATTRIBUTE46_ffv_values ,             
        ffv.ATTRIBUTE47                       ATTRIBUTE47_ffv_values ,             
        ffv.ATTRIBUTE48                       ATTRIBUTE48_ffv_values ,             
        ffv.ATTRIBUTE49                       ATTRIBUTE49_ffv_values ,             
        ffv.ATTRIBUTE50                       ATTRIBUTE50_ffv_values ,             
        ffv.ATTRIBUTE_SORT_ORDER               ATTRIBUTE_SORT_ORDER_ffv_values ,               
        ffv.ZD_EDITION_NAME                   ZD_EDITION_NAME_ffv_values ,             
        ffv.ZD_SYNC                           ZD_SYNC_ffv_values ,             
        ffv.FETCH_DATE                         FETCH_DATE_ffv_values  ,              
        
        ffvt.BZ_BIS_CREATED_BY           BZ_BIS_CREATED_BY_ffv_tl ,         
        ffvt.BZ_BIS_CREATION_DATE       BZ_BIS_CREATION_DATE_ffv_tl ,
        ffvt.BZ_BIS_UPTATED_BY           BZ_BIS_UPTATED_BY_ffv_tl ,           
        ffvt.BZ_BIS_UPDATED_DATE        BZ_BIS_UPDATED_DATE_ffv_tl ,
        ffvt.FLEX_VALUE_ID               FLEX_VALUE_ID_ffv_tl ,             
        ffvt.LANGUAGE                    LANGUAGE_ffv_tl ,          
        ffvt.LAST_UPDATE_DATE            LAST_UPDATE_DATE_ffv_tl ,              
        ffvt.LAST_UPDATED_BY             LAST_UPDATED_BY_ffv_tl ,               
        ffvt.CREATION_DATE               CREATION_DATE_ffv_tl ,               
        ffvt.CREATED_BY                  CREATED_BY_ffv_tl ,               
        ffvt.LAST_UPDATE_LOGIN           LAST_UPDATE_LOGIN_ffv_tl ,               
        ffvt.DESCRIPTION                 DESCRIPTION_ffv_tl ,            
        ffvt.SOURCE_LANG                 SOURCE_LANG_ffv_tl ,            
        ffvt.FLEX_VALUE_MEANING          FLEX_VALUE_MEANING_ffv_tl ,            
        ffvt.ZD_EDITION_NAME             ZD_EDITION_NAME_ffv_tl ,            
        ffvt.ZD_SYNC                     ZD_SYNC_ffv_tl ,            
        ffvt.FETCH_DATE                  FETCH_DATE_ffv_tl ,               
        ffvt.FETCH_YEAR                  FETCH_YEAR_ffv_tl ,            
        ffvt.FETCH_MONTH                 FETCH_MONTH_ffv_tl ,            
        ffvt.FETCH_DAY                   FETCH_DAY_ffv_tl  ,
        ROWNUM AS ROW_NUMBER_ID,  
        SYSDATE AS ROW_CREATION_DATE,  
        SYSDATE AS ROW_LAST_UPDATE_DATE
