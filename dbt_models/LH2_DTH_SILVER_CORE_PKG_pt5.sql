...
SELECT TO_TIMESTAMP('01/01/52 00:00:00', 'DD/MM/YY HH24:MI:SS.FF9') AS HAOU_DATE_FROM, 'LS AUSTRALIA' AS HAOU_NAME, TO_TIMESTAMP('08/01/15 12:31:24', 'DD/MM/YY HH24:MI:SS.FF9') AS HAOU_LAST_UPDATE_DATE, 10227 AS HAOU_LAST_UPDATED_BY, 64135079 AS HAOU_LAST_UPDATE_LOGIN, 10227 AS HAOU_CREATED_BY, TO_TIMESTAMP('08/01/15 11:05:10', 'DD/MM/YY HH24:MI:SS.FF9') AS HAOU_CREATION_DATE, 2 AS HAOU_OBJECT_VERSION_NUMBER, 0 AS HOU_BUSINESS_GROUP_ID, 99994 AS HOU_ORGANIZATION_ID, 'LS AUSTRALIA' AS HOU_NAME, 'AU' AS HLA_COUNTRY, 'AUD' AS GSOB_CURRENCY_CODE, sysdate AS ROW_CREATION_DATE, sysdate AS ROW_LAST_UPDATE_DATE
