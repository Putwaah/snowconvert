...
SELECT 'AUSTRALIA' AS BU_GL_SEGMENT1, 101 AS CHART_OF_ACCOUNTS_ID, 'LS-Australia' AS BU_GL_DESCRIPTION, 'MERGE' AS BU_GL_REGROUPEMENT_VENTE, 'ASIA' AS BU_GL_REGROUPEMENT_ACHAT, TO_TIMESTAMP('01/01/52 00:00:00', 'DD/MM/YY HH24:MI:SS.FF9') AS DATE_MAJ_EXCEL, null AS COMMENTAIRES, TO_TIMESTAMP('01/01/52 00:00:00', 'DD/MM/YY HH24:MI:SS.FF9') AS CREATION_DATE, null AS CREATED_BY, null AS LAST_UPDATE_DATE, null AS LAST_UPDATED_BY, 9999999997 AS ROW_NUMBER_ID, SYSDATE AS ROW_CREATION_DATE, SYSDATE AS ROW_LAST_UPDATE_DATE, 'N' AS BU_GL_PERIMETRE_SALESFORCE
